...
def main():
    ...
    graphs_file_path = './re_graph_scale500_sigma1_minsize1.pkl'  # Change to your RAGs directory path
    ...
    np.save(os.path.join(save_path, f'reconstructed_matrix_s500s1m1_5decimal.npy'), reconstructed_matrices)
    # Example usage
    ...
    plt.savefig('The Distribution of Pixel-wise MAE-'+min_size+'.png')

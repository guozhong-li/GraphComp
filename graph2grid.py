...
def main():
    ...
    graphs_file_path = './re_graph_scale500_sigma1_minsize500.pkl'  # Change to your RAGs directory path
    ...
    np.save(os.path.join(save_path, f'reconstructed_matrix_s500s1m500_5decimal.npy'), reconstructed_matrices)
    # Example usage
